...
//    .......
    CCAction *completeAction;
    CCAction* callbackChannelAction;
    CCAction* soundChannelAction;
    
public:
    
    void switchToCCBTimeLine(CCNode* node,void* data);
...
private:
    ...
    CCActionInterval* getAction(CCBKeyframe *pKeyframe0, CCBKeyframe *pKeyframe1, const char *pPropName, CCNode *pNode,bool last);
