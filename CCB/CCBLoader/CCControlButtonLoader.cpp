...
void CCControlButtonLoader::onHandlePropTypeSound(cocos2d::CCNode *pNode, cocos2d::CCNode *pParent, const char *pPropertyName, const char *pText, cocos2d::extension::CCBReader *pCCBReader){
